...
android {
    namespace "jp.room417.jirotravelersmap.model"
...
def buildSwiftAll = tasks.register("buildSwiftAll") {
    ...
    outputs.dir(layout.buildDirectory.dir("../.build/plugins/outputs/${layout.projectDirectory.asFile.getName().toLowerCase()}/SwiftHashing/destination/JExtractSwiftPlugin/src/generated/java"))
}
